...
namespace AuthenicationServer.Business_logic.services
{
    public class AuthenticationManager : IAuthenticationManager
    {
       ...
       configuration)
        ...
        public async Task<User> ValidateUserById(GetUserByIdDto userForAuth)
        {
            return await _userManager.FindByIdAsync(userForAuth.userId);
            
        }

        public async Task<string> ValidateUserByEmail(UserForAuthenticationDto userForAuth)
        {
